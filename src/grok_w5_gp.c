...
extern void (*D_004C2654)(void);

extern void func_0012E780(s32);
extern void func_002C3200(void);

void func_00152960(void) {
    void (*fp)(void) = D_004C2654;
    if (fp)
        fp();
}

void func_002C31F0(void) {
    D_004C28D8[0] = 2;
    func_002C3200();
}
