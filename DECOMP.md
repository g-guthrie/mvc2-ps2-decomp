...
ranges. `make match` verifies all 4,828 functions and 202,324/202,324 bytes
directly against retail, resolving HI16/LO16, R_MIPS_26, and GPREL16
relocations. The exact hybrid link places all 4,828 compiled functions at their
retail addresses, so all 202,324 bytes count as `complete_code`; 89,432 bytes
