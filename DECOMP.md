...
ranges. `make match` verifies all 4,821 functions and 202,088/202,088 bytes
directly against retail, resolving HI16/LO16, R_MIPS_26, and GPREL16
relocations. The exact hybrid link places all 4,821 compiled functions at their
retail addresses, so all 202,088 bytes count as `complete_code`; the split
