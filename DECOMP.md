...
ranges. `make match` verifies all 4,754 functions and 196,924/196,924 bytes
directly against retail, resolving HI16/LO16, R_MIPS_26, and GPREL16
relocations. The exact hybrid link places all 4,754 compiled functions at their
retail addresses, so all 196,924 bytes count as `complete_code`; the split
