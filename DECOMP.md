...
ranges. `make match` verifies all 4,677 functions and 194,904/194,904 bytes
directly against retail, resolving HI16/LO16, R_MIPS_26, and GPREL16
relocations. The exact hybrid link places all 4,677 compiled functions at their
retail addresses, so all 194,904 bytes count as `complete_code`; the split
