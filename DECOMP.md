...
ranges. `make match` verifies all 4,796 functions and 199,788/199,788 bytes
directly against retail, resolving HI16/LO16, R_MIPS_26, and GPREL16
relocations. The exact hybrid link places all 4,796 compiled functions at their
retail addresses, so all 199,788 bytes count as `complete_code`; the split
